...
public class NotificationManager : INotificationService
{
    ...
    private readonly ETicaret.Business.Infrastructure.Messaging.IFcmService _fcmService;

    public NotificationManager(IRepository<Notification> repo, ILogService logService, ISmsService smsService, ETicaret.Business.Infrastructure.Messaging.IFcmService fcmService)
    {
        _repo = repo;
