...
using ETicaret.Data;
using ETicaret.Web.Components;
using ETicaret.Web.States;
...
ETicaret.SharedUI.DependencyInjection.AddSharedApiServices(builder.Services);
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(ETicaret.SharedUI.Routes).Assembly);
