...
{
    c.SwaggerDoc("v1", new() { Title = "ETicaret API", Version = "v1" });
});
...
builder.Services.AddCors(options =>
{
    ...
    options.AddPolicy("Production", b => b
        .WithOrigins(
            ...
            ?? ["https://ETicaret.com", "https://www.ETicaret.com"])
        .AllowAnyMethod()
        .AllowAnyHeader()
        .AllowCredentials());
});
...
app.MapControllers();
app.MapHub<ETicaret.API.Hubs.NotificationHub>("/hubs/notifications");
