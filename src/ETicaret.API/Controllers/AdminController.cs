...
public class AdminController : ControllerBase
{
    ...
    public async Task<IActionResult> GetSettings()
    {
        ...
        var settings = new List<ETicaret.Business.DTOs.GlobalSettingDto>
        {
    ...
    [HttpPut("settings")]
    public async Task<IActionResult> UpdateSetting([FromBody] ETicaret.Business.DTOs.GlobalSettingDto dto)
    {
    ...
    // ─── FCM Test ─────────────────────────────────────────────
    [HttpPost("test-fcm")]
    public async Task<IActionResult> TestFcm([FromBody] FcmTestDto dto, [FromServices] ETicaret.Business.Infrastructure.Messaging.IFcmService fcmService)
    {
        try
        {
